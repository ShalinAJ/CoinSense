        ...
        <div className="flex flex-col lg:flex-row text-center lg:text-left items-center lg:items-start justify-between px-[10px] lg:px-[28px] pt-[29px]">
          <div>
            <FadeIn>
              ...
              <h2 className="text-lg lg:text-2xl font-bold">Expense Data</h2>
          ...
          <RightSlide>
            <div className="bg-[#ff00001f] text-[#ff0000] rounded-lg flex flex-row justify-center mt-2 lg:mt-0 py-2 px-4 lg:mr-3 text-xs lg:text-[13px]">
              <p className="text-black pr-1 lg:pr-2">Expense count: </p>
