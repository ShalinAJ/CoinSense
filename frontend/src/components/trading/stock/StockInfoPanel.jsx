    ...
    <FadeIn>
      <div className="mb-10 py-6 rounded-3xl border shadow-sm hover:shadow-lg shadow-grey-500/40 transition-shadow duration-300">
        <div className="h-[25rem] max-h-[24rem] overflow-y-auto ">
          <div className="flex flex-row items-center gap-2 pb-6 lg:pb-10 pr-4 pl-4 lg:pr-7 lg:pl-7">
            {" "}
            <img
              src={stockData.logo}
          ...
          <div className="flex flex-col pb-10 pr-4 pl-4 lg:pr-7 lg:pl-7">
          ...
          <div className="flex flex-col justify-between h-max pr-7 pl-7 w-[100%]">
           ...
           font-medium"
            ...
            <div className="grid grid-cols-3 lg:grid-cols-4 gap-4 mt-4 w-[100%] text-[12px] font-semibold">
              <div className="pb-6">
