  ...
  return (
    <div className="bg-coinsense-blue lg:bg-transparent pt-[2rem] pb-[6rem] mt-[2rem] flex relative overflow-hidden">
      ...
      <div className="z-10 px-8 md:px-12 lg:px-20 flex flex-col md:flex-row w-full items-start">
        <div className="z-20 pt-10 lg:pt-28 w-full lg:w-[40%] md:text-left">
          ...
          <button className="mt-4 text-xs font-medium rounded-full px-5 py-2 text-black bg-white lg:text-white lg:bg-coinsense-blue">
            View Demo
          </button>
        </div>
